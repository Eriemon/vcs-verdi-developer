...
Use `erie-remote-ssh` for every default remote EDA server validation task.

## Order

1. Discover configured servers and select the default remote EDA server for the current validation task.
...
7. For full-flow acceptance, follow `remote-gate.md`.
