...
# 调用 analyze_logs Python 主程序统一执行日志诊断，让参数解析、失败判定与退出码策略只维护在这一份实现里
& python (Join-Path $pathSkillRoot 'scripts\python\diagnosis\analyze_logs.py') @RemainingArguments
